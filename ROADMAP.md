...
| 2 | Instrument exploration and financial charts | Specified and planned | `005-instrument-exploration` (on its own branch; not on `main` yet) | Milestone 1 | Search/browse, instrument detail, responsive candlestick/volume history, overlays, and basic statistics. |
