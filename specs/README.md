...
| 013 | [Reusable feature engine](013-feature-engine/spec.md) | Planned | [Planned](013-feature-engine/plan.md) | Not started | 002, 004 | Deterministic, versioned, point-in-time features over stored sessions. Owns the definitions feature 005 displays. Relative strength is measured against an equal-weighted composite of the curated universe, decided 2026-08-31. |
