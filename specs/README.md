...
| 005 | [Instrument exploration and financial charts](005-instrument-exploration/spec.md) | In review | [Complete](005-instrument-exploration/plan.md) | [Complete](005-instrument-exploration/tasks.md) | 002, 004 | Browsable universe and daily candlestick/volume history with quality, actions, and gaps surfaced honestly. Added the missing `corporate_action.changed.v1` event, and fixed a shipped defect where the client subscribed to the SSE stream by the wrong event name and received nothing. |
