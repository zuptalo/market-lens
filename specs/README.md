...
| 023 | [Personal risk limits](023-personal-risk-limits/spec.md) | Planned | Pending | Pending | 014, 022 | A person states the limits they want to be held to — concentration by instrument, sector and market, and the number of holdings — and the product reports where they stand with the arithmetic behind every figure. It publishes no default limits and suggests no thresholds, states the gap without saying what would close it, and reports a limit as unevaluable rather than satisfied when a holding cannot be priced. Nothing it does blocks a recorded trade. |
