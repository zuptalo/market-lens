...
func TestLoadMigrations(t *testing.T) {
	...
	if len(migrations) != 32 || migrations[0].version != 1 || migrations[0].name != "0001_baseline.sql" ||
		...
		migrations[15].version != 16 || migrations[15].name != "0016_kojamo_becomes_lumo.sql" ||
		migrations[16].version != 17 || migrations[16].name != "0017_feature_definitions.sql" ||
		migrations[17].version != 18 || migrations[17].name != "0018_feature_values.sql" ||
		migrations[18].version != 19 || migrations[18].name != "0019_markets_adopt_engine_statistics.sql" ||
		migrations[19].version != 20 || migrations[19].name != "0020_sector_classification.sql" ||
		migrations[20].version != 21 || migrations[20].name != "0021_strategies_and_signals.sql" ||
		migrations[21].version != 22 || migrations[21].name != "0022_revised_session_count.sql" ||
		migrations[22].version != 23 || migrations[22].name != "0023_finding_reexamination.sql" ||
		migrations[23].version != 24 || migrations[23].name != "0024_market_series.sql" ||
		migrations[24].version != 25 || migrations[24].name != "0025_backtests.sql" ||
		migrations[25].version != 26 || migrations[25].name != "0026_personal_portfolios.sql" ||
		migrations[26].version != 27 || migrations[26].name != "0027_risk_limits.sql" ||
		migrations[27].version != 28 || migrations[27].name != "0028_order_intents.sql" ||
		migrations[28].version != 29 || migrations[28].name != "0029_paper_trading.sql" ||
		migrations[29].version != 30 || migrations[29].name != "0030_notifications.sql" ||
