...
while [ $i -le $# ]; do
    ...
    case "$arg" in
        ...
        --help|-h)
            ...
            echo "  --category <c>      Optional spec band: planned (0001+), adhoc (1001+), hotfix (2001+)."
...
# --- Optional category bands -------------------------------------------------
# Category bands let teams distinguish planned, ad-hoc, and corrective work:
...
# stay "NNNN-slug" with no type prefix).
