...
**Tests**: Tests are MANDATORY. Every production-code task MUST be preceded by a focused
...
```bash
# Launch all tests for User Story 1 together and verify the expected red state:
