...
grep -Fq 'key: EXTERNAL_CREDENTIAL_KEY_VERSION' "$DIR/20-market-lens.yaml"
grep -Fq -- '--from-literal=EXTERNAL_CREDENTIAL_KEY="$external_credential_key"' "$DIR/install.sh"
grep -Fq -- '--from-literal=EXTERNAL_CREDENTIAL_KEY_VERSION="1"' "$DIR/install.sh"
grep -Fq '.data.EXTERNAL_CREDENTIAL_KEY' "$DIR/install.sh"
grep -Fq '.data.EXTERNAL_CREDENTIAL_KEY_VERSION' "$DIR/install.sh"
